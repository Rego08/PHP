...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-4"><img src="img/devlin.jpg"></div>
            <div class="col-sm-4"><img src="img/freeland.jpg"></div>
            <div class="col-sm-4"><img src="img/gabriel.jpg"></div>
            <div class="col-sm-4"><img src="img/peterus.jpg"></div>
            <div class="col-sm-4"><img src="img/prentice.jpg"></div>
            <div class="col-sm-4"><img src="img/pete.jpg"></div>
        </div>
    </div>
